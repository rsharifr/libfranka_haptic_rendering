...
int main(int argc, char** argv) {
  ...
  const double translational_stiffness{250.0};
  ...
  damping.setZero();
  damping.topLeftCorner(3, 3) << 0.707 * sqrt(translational_stiffness) *
                                     Eigen::MatrixXd::Identity(3, 3);
  damping.bottomRightCorner(3, 3) << 0.707 * sqrt(rotational_stiffness) *
                                         Eigen::MatrixXd::Identity(3, 3);
