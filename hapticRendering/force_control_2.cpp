...
#include "hapticRendering_common.h"
...
int main(int argc, char** argv) {
  ...
  constexpr double k_p{0.0};  //1          // NOLINT(readability-identifier-naming)
  constexpr double k_i{0.0};  //2          // NOLINT(readability-identifier-naming)
  ...
  try {
    ...
    std::cout << "Initial external torques measured:" << std::endl;
    std::cout<< initial_tau_ext << std::endl;
    std::cout << "Initial gravity measured:" << std::endl;
    std::cout<< initial_gravity << std::endl;
